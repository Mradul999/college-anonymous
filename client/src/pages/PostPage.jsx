...
export default function PostPage() {
  ...
  if (loading)
    return (
      <div
        className={`w-full min-h-screen pt-20 pb-20 flex justify-center items-center ${
  ...
  return (
    <div
      className={`w-full min-h-screen pt-20 pb-20 flex justify-center ${
        theme === "dark" ? "bg-background-dark" : "bg-[#F0F2F5]"
      }`}
    >
      ...
      <div className="max-w-[800px] px-4 mt-2 mb-10 items-center w-full flex gap-6 flex-col">
        <div
          className={`w-full ${
            theme === "dark" ? "bg-cardBg-dark" : "bg-white"
        ...
        >
          ...
          {post.image && (
            <img
              src={post.image}
              alt={post.title}
              className="w-full h-auto rounded-lg mb-4 object-contain max-h-[400px]"
            />
          )}
        ...
        <hr
          className={`w-full border-t-2 ${
            theme === "dark"
              ? "border-gray-700"
              : "border-[#1877F2] border-opacity-20"
          } my-4`}
        />
