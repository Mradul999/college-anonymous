...
export default function VerifyOTP() {
  ...
  return (
    ...
    >
      <div
        className={`max-w-[450px] rounded-lg shadow-md flex flex-col gap-6 py-8 px-6 w-full ${
          theme === "dark"
            ? "bg-cardBg-dark border-gray-700"
      ...
      >
        ...
        <form onSubmit={submitHandler} className="flex flex-col gap-4">
          <input
            ...
            type="text"
            className={`w-full rounded-md py-3 px-4 border focus:outline-none focus:ring-2 focus:ring-[#1877F2] focus:border-transparent transition-all ${
              theme === "dark"
